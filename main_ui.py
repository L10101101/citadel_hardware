...
"")
        ...
        self.verticalLayout3.setContentsMargins(50, 50, 50, 50)
        self.verticalLayout3.setSpacing(50)
        ...
        self.cameraLayout_2.setContentsMargins(-1, 22, -1, 22)
        ...
        self.cameraFeed_2.setMinimumSize(QtCore.QSize(600, 400))
        ...
        self.verticalLayout3_2 = QtWidgets.QVBoxLayout(self.detailsWidget_2)
        self.verticalLayout3_2.setContentsMargins(10, 10, 10, 10)
        ...
        self.detailsLayout_2.setContentsMargins(30, 30, 30, 30)
        self.detailsLayout_2.setSpacing(10)
        self.detailsLayout_2.setObjectName("detailsLayout_2")
        self.buttonsLayout_2 = QtWidgets.QHBoxLayout()
        self.buttonsLayout_2.setObjectName("buttonsLayout_2")
        self.buttonsWidget = QtWidgets.QWidget(parent=self.detailsWidget_2)
        ...
        self.btnFinger = QtWidgets.QPushButton(parent=self.buttonsWidget)
        self.btnFinger.setMinimumSize(QtCore.QSize(0, 50))
        self.btnFinger.setObjectName("btnFinger")
        self.horizontalLayout_3.addWidget(self.btnFinger)
        self.btnFace = QtWidgets.QPushButton(parent=self.buttonsWidget)
        self.btnFace.setMinimumSize(QtCore.QSize(0, 50))
        self.btnFace.setObjectName("btnFace")
        self.horizontalLayout_3.addWidget(self.btnFace)
        self.buttonsLayout_2.addWidget(self.buttonsWidget)
        self.detailsLayout_2.addLayout(self.buttonsLayout_2)
        self.studentNoVerticalLayout_3 = QtWidgets.QVBoxLayout()
        self.studentNoVerticalLayout_3.setContentsMargins(10, 10, 10, 10)
        ...
        self.detailsLayout_2.addLayout(self.studentNoVerticalLayout_3)
        ...
        self.statusWidget_2.setMinimumSize(QtCore.QSize(100, 50))
        ...
        self.detailsLayout_2.addLayout(self.statusLayout4_2)
        self.verticalLayout3_2.addLayout(self.detailsLayout_2)
        self.horizontalLayout3_2.addWidget(self.detailsWidget_2)
